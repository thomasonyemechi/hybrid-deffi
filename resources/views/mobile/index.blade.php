                    ...
                    <div class="swiper-wrapper" id="swiper-wrapper-58b5a9a38e046c3c" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                        ...
                        <div class="swiper-slide">
                            <a href="javascript:;" class="coin-box d-block">
                                ...
                                <div class="coin-price d-flex justify-content-between">
                                    <span>{{ number_format($pc_balance, 2) }} HBC <br> <small  style="font-size: 10px; color: rgb(197, 186, 186)" >${{ number_format($pc_total, 4) }}</small>  </span>
                                    <span class="text-primary d-flex align-items-center gap-2"><i class="icon-select-up"></i> ${{ number_format(1 / $rate, 2) }}</span>
                                </div>
                                <div class="blur bg1">
                                </div>
                            </a>
                        ...
                        <div class="swiper-slide">
                            <a href="javascript:;" class="coin-box d-block">
                                ...
                                <div class="coin-price d-flex justify-content-between">
                                    <span> {{ number_format($spc_balance, 2) }} SHC <br> <small  style="font-size: 10px; color: rgb(197, 186, 186)" >$ ${{ number_format($spc_balance, 2) }}</small>   </span>
                            ...
                            @foreach ($transactions as $trno)
                                ...
                                <li class="mt-8" >
                                    <a href="javascript:;" class="coin-item style-1 gap-12 bg-surface">
                                        ...
                                        <div class="content">
                                            <div class="title">
                                                <p class="mb-4 text-large {{ ($trno->amount > 0) ? 'text-success' : 'text-danger' }} "  >{{ number_format($trno->amount, 2) }} {{ $trno->currency }}</p>
