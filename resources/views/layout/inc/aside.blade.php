<aside class="sidebar sidebar-default navs-rounded ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="/dashboard" class="navbar-brand dis-none align-items-center">
            <h4 class="logo-title m-0">Hybridcoin Admin</h4>
        </a>
    ...
    <div class="sidebar-body p-0 data-scrollbar">
        <div class="navbar-collapse pe-3" id="sidebar">
            <ul class="navbar-nav iq-main-menu">
                ...
                <li>
                    <span class="fw-bold badge ps-4">Transactions</span>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-special" role="button"
                        ...
                        <span class="item-name">Funds Deposit</span>
                        <i class="right-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#withdarwals" role="button"
                        aria-expanded="false" aria-controls="sidebar-special">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <ul class="sub-nav collapse" id="withdarwals" data-bs-parent="#sidebar">
                        <li class="nav-item">
                            <a class="nav-link " href="/admin/withdrawal/history">
                                ...
                                <i class="sidenav-mini-icon">P </i>
                                <span class="item-name">All Withdarwals</span>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <li>
                    <span class="fw-bold badge ps-4">User Management</span>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="/admin/users/royalty">
                        ...
                        <span class="item-name">Royalty BenchMarkers</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link " aria-current="page" href="/admin/credit/royalty">
                        <i class="icon">
                            <svg width="22" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <span class="item-name">Credit Royalty </span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="/admin/debit">
                        ...
                        <span class="item-name">Debit user</span>
                    </a>
                </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link " aria-current="page" href="/admin/zone">
                        <i class="icon">
                            <svg width="22" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <span class="item-name">Zone Overview </span>
                    </a>
                </li>


                <li class="nav-item ">
                    <a class="nav-link " aria-current="page" href="/admin/slot_info">
                        <i class="icon">
                            <svg width="22" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="nav-item ">
                    <a class="nav-link " aria-current="page" href="/admin/zone/transactions">
                        <i class="icon">
                            <svg width="22" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li>
                    <span class="fw-bold badge ps-4">Settings</span>
                </li>


                <li class="nav-item ">
                    <a class="nav-link " aria-current="page" href="/admin/announcement">
                        <i class="icon">
                            <svg width="22" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="nav-item ">
                    <a class="nav-link" aria-current="page" href="/admin/manage-wallet">
                        ...
                        <span class="item-name">Manage Deposit Wallets</span>
                    </a>
                </li>
